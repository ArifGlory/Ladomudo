...
@section('breadcrumb')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-user-circle'></i> Tambah Supplier
            <small>
                Silahkan isi data Supplier
            </small>
        </h1>
...
@section('content')
    {!! Form::open(['route' => 'supplier.store', 'method' => 'POST', 'id' => 'form-pegawai', 'files' => true]) !!}
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-8">
                                {!! Form::text('nama_supplier', null, ['class' => 'form-control', $errors->has('nama_supplier') ? 'form-control-danger' : '', 'placeholder' => 'Nama Supplier'
                                , 'required' => 'required']) !!}
                                @error('nama_supplier')
