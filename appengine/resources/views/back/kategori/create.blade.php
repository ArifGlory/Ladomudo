...
@section('breadcrumb')
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-user-circle'></i> Tambah Kategori
            <small>
                Silahkan isi data Kategori
            </small>
        </h1>
...
@section('content')
    {!! Form::open(['route' => 'kategori.store', 'method' => 'POST', 'id' => 'form-pegawai', 'files' => true]) !!}
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-8">
                                {!! Form::text('nama_kategori', null, ['class' => 'form-control', $errors->has('nama_kategori') ? 'form-control-danger' : '', 'placeholder' => 'Nama Kategori'
                                , 'required' => 'required']) !!}
                                @error('nama_kategori')
